...
@interface PostCommentViewController ()<UIImagePickerControllerDelegate,UINavigationControllerDelegate,UIActionSheetDelegate,TZImagePickerControllerDelegate,YYTextViewDelegate> {
...
//    CustomYYImage *imageView = _textView.textLayout.attachments[0].content;  //可以取到imageView.image
    ...
    [self postBrainholeText];  //提交

    
}

/* 脑洞评论 */
- (void)postBrainholeText {
    //禁止连续点击
