...
-(void)setModel:(LXCalendarDayModel *)model{
    ...
    if (model.isNextMonth || model.isLastMonth) {
        ...
        if (model.isSelected) {
            ...
            self.label.textColor = model.selectLabelColor?model.selectLabelColor:[UIColor colorWithRed:52/255.0 green:51/255.0 blue:56/255.0 alpha:1.0];
...
//                 [self addAnimaiton];
            ...
            self.label.textColor = model.currentMonthTitleColor?model.currentMonthTitleColor:[UIColor colorWithRed:52/255.0 green:51/255.0 blue:56/255.0 alpha:1.0];
        }
