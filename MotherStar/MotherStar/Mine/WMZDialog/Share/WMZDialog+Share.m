...
//    self.titleLabel.font = [UIFont fontWithName:@"PingFangSC" size: 8];
...
//    shareView.frame = CGRectMake(0, CGRectGetMaxY(upLine.frame)+self.wMainOffsetY, self.wWidth ,self.wHeight*2);
    shareView.frame = CGRectMake(0, CGRectGetMaxY(self.titleLabel.frame)+self.wMainOffsetY, self.wWidth ,self.wHeight*2);
